...
const Home = () => {
  return (
    <section>
      <hr/>
      <section className='flex justify-center bg-gray-800 p-4'>
      ...
      <section className='pl-16 pt-2 pb-2 pr-16'>
        <p className='text-2xl text-justify pb-2'><strong>What is a Mutawatir Hadith and why this is distinct?</strong></p>
      ...
      <section className='flex justify-center'>
        <Link href="./hadithIndex" className='mr-5'>
